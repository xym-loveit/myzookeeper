...
public class SubscribeZkClient {
    ...
    private static final String ZOOKEEPER_SERVER = "192.168.2.135:2181";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            for (int i = 0; i < CLIENT_QTY; ++i) {
                ZkClient client = new ZkClient(ZOOKEEPER_SERVER, 5000, 5000, new BytesPushThroughSerializer());//注意这里的序列化类
                clients.add(client);
